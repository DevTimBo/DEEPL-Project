    ...
    def analyze(self):
        ...
        if self.analyze_mode.currentText() == "Single Image":
            if self.single_image != "":
                self.single_image_analyzer(model, preprocess, decode_predictions)
        elif self.analyze_mode.currentText() == "Many Images":
            pass
        elif self.analyze_mode.currentText() == "Video":
            pass

    def single_image_analyzer(self, model, preprocess, decode_predictions):
        image_list = []
        title_list = []
        cmap_list = []
